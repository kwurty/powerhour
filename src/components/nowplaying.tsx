      ...
      <div className="w-full bg-gray-800 rounded-lg shadow-lg p-4">
        ...
        {user && user.id === playlist.user_id && (
          <div className="w-full flex justify-center rounded-md shadow-sm">
            ...
            <button className="text-slate-800 hover:text-cinnabar-600 text-sm bg-white hover:bg-slate-100 border border-slate-200 rounded-r-lg font-medium px-4 py-2 inline-flex space-x-1 items-center">
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
